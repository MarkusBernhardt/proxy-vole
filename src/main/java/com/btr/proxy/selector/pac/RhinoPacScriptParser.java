 ...
 * Depends on js.jar of the <a href="http://www.mozilla.org/rhino/">Apache
 * Rhino </a> project.
 * <p>
...
public class RhinoPacScriptParser extends ScriptableObject implements PacScriptParser {
    ...
    private static final String[] JS_FUNCTION_NAMES = { "shExpMatch", "dnsResolve", "isResolvable", "isInNet",
            "dnsDomainIs", "isPlainHostName", "myIpAddress", "dnsDomainLevels", "localHostOrDomainIs", "weekdayRange",
            "dateRange", "timeRange" };
    ...
    public String evaluate(String url, String host) throws ProxyEvaluationException {
        try {
            ...
            try {
                Object result = context.evaluateString(this.scope, script.toString(), "userPacFile", 1, null);
