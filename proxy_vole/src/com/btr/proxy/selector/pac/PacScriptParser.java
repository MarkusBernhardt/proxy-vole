...
public class PacScriptParser extends ScriptableObject {
	...
	private static List<String> MONTH = Collections.unmodifiableList(
	...
	public PacScriptParser(PacScriptSource source) throws ProxyEvaluationException {
		super();
		this.source = source;
...
// ***************************************************************************
	...
	public static boolean isResolvable(String host) {
		try {
			...
			Logger.log(PacScriptParser.class, LogLevel.DEBUG, "Hostname not resolveable {0}.", host);
			// Not resolvable
		}
		return false;
	}
	...
	public static String dnsResolve(String host) {
		try {
			...
			Logger.log(PacScriptParser.class, LogLevel.DEBUG, "DNS name not resolvable {0}.", host);
			// Not resolvable.
		}
		return "";
	}
	...
	public static String myIpAddress() {
		try {
			...
			Logger.log(PacScriptParser.class, LogLevel.DEBUG, "Local address not resolvable.");
			return "";
		}
	}
	...
	public static boolean shExpMatch(String str, String shexp) {
		...
		while (tokenizer.hasMoreTokens()) {
			...
			// 07.05.2009 Incorrect? first token can be startsWith and last one can be endsWith
	 ...
	 * This is used by the date and time based methods.
	...
	private static Calendar getCurrentTime(boolean useGmt) {
		...
		return Calendar.getInstance(
				useGmt?TimeZone.getTimeZone(GMT):TimeZone.getDefault());
	}
	...
	public static boolean timeRange(Object hour1, Object min1, Object sec1, Object hour2, Object min2, Object sec2, Object gmt) {
		boolean useGmt = 
					GMT.equalsIgnoreCase(String.valueOf(min1)) ||
